...
public class DatabaseUI extends JFrame {
    ...
    public DatabaseUI(Connection connection) throws SQLException {
        ...
        try {
            Path path = Paths.get("C:\\Users\\pasha\\Desktop\\backup\\prev_states\\");
        ...
        boolean admin = connection.getMetaData().getUserName().equals("sushko");
        if (!admin) {
        ...
        downloadBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JFileChooser fileChooser = new JFileChooser("C:\\Users\\pasha\\Desktop\\backup");
        ...
        backBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                File file = new File("C:\\Users\\pasha\\Desktop\\backup\\prev_states\\" + last + ".sql");
                if (dtPicker.datePicker.isTextFieldValid() && dtPicker.timePicker.isTextFieldValid() && dtPicker.getDateTimeStrict() != null)
                {
                    try {
                        ...
                        while (dtPicker.getDateTimeStrict().isBefore(ldt))
                        {
                            ...
                            file = new File("C:\\Users\\pasha\\Desktop\\backup\\prev_states\\" + last + ".sql");
