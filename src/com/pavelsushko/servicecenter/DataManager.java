...
public class DataManager {
    ...
    public static boolean exportDatabase(String fileName, boolean dataOnly) {
        String dir = "C:\\Users\\pasha\\Desktop\\backup\\" + fileName + ".sql";
        if (dataOnly)
            dir = "C:\\Users\\pasha\\Desktop\\backup\\prev_states\\" + fileName + ".sql";
        ProcessBuilder pb = new ProcessBuilder(
                ...
                "--no-password",
                "--format", "c",
                "--file", dir, "Service center");
        try {
            final Map<String, String> env = pb.environment();
            env.put("PGPASSWORD", "8246");
            Process p = pb.start();
    ...
    public static boolean importDatabase(String fileName, boolean dataOnly) {
        String dir = "C:\\Users\\pasha\\Desktop\\backup\\" + fileName;
        if (dataOnly)
            dir = "C:\\Users\\pasha\\Desktop\\backup\\prev_states\\" + fileName + ".sql";
        ProcessBuilder pb = new ProcessBuilder(
